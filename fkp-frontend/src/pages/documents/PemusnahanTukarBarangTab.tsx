// src/pages/documents/PemusnahanTukarBarangTab.tsx
//
// Konten form "Berita Acara Pemusnahan dan Tukar Barang" (SPP/QC/FORM 26).
// Ini adalah ISI ASLI BaManualPage.tsx SEBELUM ditambahkan tab BAPKP —
// logic TIDAK DIUBAH sama sekali, hanya dipindah ke komponen terpisah
// (dan bagian header/back-button dihapus karena sekarang jadi tanggung
// jawab wrapper BaManualPage.tsx yang membungkus tab switcher).
...
export function PemusnahanTukarBarangTab() {
