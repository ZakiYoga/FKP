...
async def tambah_testimoni(
    ...
    - Semua rating WAJIB diisi: rating_keseluruhan, rating_kecepatan,
      rating_komunikasi, rating_solusi, dan rating_aplikasi (1–5).
    - Komentar, kritik_saran_tim, dan kritik_saran_app bersifat opsional
      (maks. 1000 karakter masing-masing).
